...
![CALL Example](/img/call_trace_types/call_example.png "CALL represents a regular contract call, which is a direct interaction between two contracts.")
...
![DELEGATE Example](/img/call_trace_types/delegate_example.png "DELEGATE represents a call to a function in a library from another contract class, using the storage of the caller contract. 
