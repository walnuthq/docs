...
>(function FeedbackThanks({ className, ...props }, ref) {
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-pink-50/50 py-1 pl-1.5 pr-3 text-sm text-pink-900 ring-1 ring-inset ring-pink-500/20 dark:bg-BLUE/5 dark:text-pink-200 dark:ring-pink-500/30">
        <CheckIcon className="h-5 w-5 flex-none fill-BLUE stroke-white dark:fill-pink-200/20 dark:stroke-pink-200" />
