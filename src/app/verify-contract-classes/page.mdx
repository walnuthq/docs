...
Walnut supports verification of contract classes through both the Starknet Foundry's `sncast verify` command and its own API. Contact us if you need support for a different cairo version: [https://t.me/walnuthq](https://t.me/walnuthq).
